                                ...
                                <form method="POST" action="update_vendor.php">
                                    <div class="form-group row">
                                        ...
                                        <div class="input-group">
                                            <input id="nomor" name="nomor" type="text" class="form-control" value="<?php echo $d['nomor'] ?>">
                                        </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                        <div class="input-group">
                                            <input id="kota" name="kota" type="text" class="form-control" value="<?= $d['kota'] ?>">
                                        </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                        <div class="input-group">
                                            <input id="kontak" name="kontak" type="text" class="form-control" value="<?= $d['kontak'] ?>">
                                        </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
