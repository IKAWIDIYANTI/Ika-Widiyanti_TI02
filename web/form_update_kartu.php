                                ...
                                <form method="POST" action="update_kartu.php">
                                    <div class="form-group row">
                                        ...
                                        <div class="input-group">
                                            <input id="kode" name="kode" type="text" class="form-control" value="<?php echo $d['kode'] ?>">
                                        </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                        <div class="input-group">
                                            <input id="diskon" name="diskon" type="text" class="form-control" value="<?= $d['diskon'] ?>">
                                        </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                        <div class="input-group">
                                            <input id="iuran" name="iuran" type="text" class="form-control" value="<?= $d['iuran'] ?>">
                                        </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
